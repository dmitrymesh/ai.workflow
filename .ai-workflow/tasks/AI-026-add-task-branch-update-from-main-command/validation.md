...
- Unit tests: 26/26 passed (`python -m unittest test_update_from_main -v`)
  ...
  - `update_from_main` handler: requires task_id or --all, mutual exclusion, single task runs process_branch, --all scans all branches, exits 1 on conflict
